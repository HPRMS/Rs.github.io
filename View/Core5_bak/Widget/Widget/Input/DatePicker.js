...
.using("Core5.Cls")
.define(function(command,datePicker,dateTimeFormatter,pop,cls){
    var dp;
    return {
        $extend:command
        ...
        ,showPop:function(){
            ...
            this.pop.setDay(this.value).setResponser(this).show().move(pos.left ,pos.top);
        }
        ...
        ,onPopSelect:function(group,v,item,itemIndex){
            this.pop.hide();
            this.setValue(v);
            this.evt && this.report(this.evt,this.value,item,itemIndex,v);
        }
