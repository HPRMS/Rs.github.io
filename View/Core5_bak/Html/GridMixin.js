    ...
    return {
        ...
        ,_initScroll:function(){
            ...
            this._scrollBodyFn = function(event, delta){
                ...
                var innerHeight = oThis.jq(".s-grid-r-scroll-inner").height();//jq.height();
        ...
        ,_doResize:function(jqWidth,jqHeight){
            this.rightScrollHideTr && this.jq(".s-grid-body-tr").show();      //全部show出來,然後右邊scroll才能計算準確
            //檢查是否需要下面的滾動條
            var bodyWidth = this.jq(".s-grid-body").width();
            var bodyTableWidth = this.jq(".s-grid-body-table").width();
            ...
            var bodyTableHeight = this.jq(".s-grid-body-table").height();
        ...
        ,_showBottomScroll:function(bodyTableWidth){
            ...
            this.jq(".s-grid-b-scroll-inner").css("width",bodyTableWidth + "px");
        ...
        ,_showRightScroll:function(bodyTableHeight,bodyHeight,showBScroll){
            ...
            this.jq(".s-grid-r-scroll-inner").css("height",bodyTableHeight + "px");
        ...
        ,_scrollRight:function(){
            if(this.rightScrollHideTr){
                ...
                this.jq(".s-grid-body-table").css("top" , (-1 * this.jq(".s-grid-r-scroll").scrollTop()) + "px");
            }
        }
        
        ,_scrollBottom:function(){
            var srollLeft = -1 * this.jq(".s-grid-b-scroll").scrollLeft() + "px";
            this.jq(".s-grid-head-table").css("left" , srollLeft);
            this.jq(".s-grid-body-table").css("left" , srollLeft);
        }
        ...
        ,_initBodyTrHeights:function(){
            //記錄各行高
            var bodyTrs = this.jq(".s-grid-body-tr");
            //bodyTrs.show();
            var heights = [];
