...
.define(function(queryGen,dataFn,strFn,sc){
    ...
    var dataModel =  {
        ...
        ,_setSource:function(source){
            this._setCountBySource && this.set("originalCount",source?source.length:0);
            this._doFilter();
        }
...
//        }
        ...
        ,_doFilter:function(){
            var needFilter = this._needFilter();
            this._filterRows = needFilter
                ?filterRows(this.source,this.filter)
                :this.source;
            this._doSort();
            this.set("totalCount",needFilter?(this._filterRows?this._filterRows.length:0):this.originalCount);
        }
    ...
    return {
        ...
        */
        ...
        ,listQueryResult:function(ret){
            ...
            this.set("_dataListQueryTime",Math.round((this._dataListQueryEndTime - this._dataListQueryStartTime) / 1000));
            ...
            pageServer && this.set("originalCount",ret.Count);
